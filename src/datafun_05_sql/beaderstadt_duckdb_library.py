"""beaderstadt_duckdb_library.py - Project script.
...
def main() -> None:
    ...
    try:
        ...
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "beaderstadt_library_clean.sql")

        # ----------------------------------------------------
        # STEP 2: BOOTSTRAP (create tables, load CSV data)
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "beaderstadt_library_bootstrap.sql")
        ...
        # ----------------------------------------------------
        run_sql_query(con, SQL_DIR / "beaderstadt_library_query_kpi_checkouts.sql")
